...
// export default function ExternalPartyLoginPage() {
...
//         try {
//             const response = await axios.post(`http://${ipaddress}externalParty/${DecodedCompanyId1}/${DecodedBranchId1}/${encodedPartyId}/${password}/update-password`
...
//                 // Swal.fire("Password Reset successfully", ' Please Confirm The Details', 'success');
...
//                  navigate(`/ExternalParty/Confirmation_Page/${encodedCompanyId}/${encodedBranchId}/${encodedPartyId}`);
//             } else {
