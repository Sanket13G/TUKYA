...
function PreImportModel(props) {
    ...
    const getImportsOfMAWB = (compId, branchId, MAWBNo) => {
        Rate_Chart_Service.getByMAWBNoPre(compId, branchId, MAWBNo).then((res) => {
    ...
    const getByMAWBnoAndHAwb = async (compId, branchID, transId, mawb, hawb, sirNo) => {
        ...
        Rate_Chart_Service.GetByMAWBandHAWBPre(compId, branchID, transId, mawb, hawb, sirNo).then((res) => {
    ...
    const addImport = async () => {
        ...
        try {
            const res = await Rate_Chart_Service.addPreImport(companyid, branchId, userId, importData);
    ...
    const updateModify = () => {
        ...
        Rate_Chart_Service.updatePreImport(companyid, branchId, userId, importData).then((res) => {
            if (res.status === 200) {
    ...
    const DeleteImport = (compaId, branchId, transId, mawbno, hawbno, sir) => {
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Rate_Chart_Service.deletePreimportofmawb(compaId, branchId, transId, mawbno, hawbno, sir).then((res) => {
    ...
    const importData = {
        ...
        importAddress, status, createdBy, createdDate, editedBy, editedDate, approvedBy, approvedDate, dgdc_Status, closeStatus, reasonforOverride, nsdlStatusDocs,
